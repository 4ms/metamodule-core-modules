...
struct DEVInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 44> Elements{{
		...
		Knob9mm{{to_mm<72>(93.13), to_mm<72>(95.86), Center, "Level A", ""}, 1.0f, -100.0, 100.0, "%"},
		Knob9mm{{to_mm<72>(137.25), to_mm<72>(95.86), Center, "Level B", ""}, 1.0f, -100.0, 100.0, "%"},
		Knob9mm{{to_mm<72>(93.13), to_mm<72>(138.65), Center, "Offset A", ""}, 0.5f, -100.0, 100.0, "%"},
		Knob9mm{{to_mm<72>(137.25), to_mm<72>(138.65), Center, "Offset B", ""}, 0.5f, -100.0, 100.0, "%"},
