...
struct DLDInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 56> Elements{{
		...
		Davies1900hBlackKnob{{to_mm<72>(43.46), to_mm<72>(184.04), Center, "Delay Feed A", ""}, 1.0f, 0.0, 110.0, "%"},
		...
		Davies1900hBlackKnob{{to_mm<72>(245.19), to_mm<72>(183.78), Center, "Delay Feed B", ""}, 1.0f, 0.0, 110.0, "%"},
		...
		AltParamChoiceLabeled{{{to_mm<72>(29.0), to_mm<72>(13.0), Center, "Soft Clip A", ""}, 2, 0}, {"On", "Off"}},
		...
		AltParamChoiceLabeled{{{to_mm<72>(165.98), to_mm<72>(242.1), Center, "Rev. B", ""}, 2, 0}, {"Trig", "Gate"}},
		AltParamChoiceLabeled{{{to_mm<72>(43.46), to_mm<72>(184.04), Center, "DelayFeed A Taper", ""}, 2, 0}, {"Log", "Lin"}},
		AltParamChoiceLabeled{{{to_mm<72>(245.19), to_mm<72>(183.78), Center, "DelayFeed B Taper", ""}, 2, 0}, {"Log", "Lin"}},
		AltParamChoiceLabeled{{{to_mm<72>(25.58), to_mm<72>(322.03), Center, "Time A Auto-UnQ", ""}, 2, 0}, {"Off", "On"}},
		AltParamChoiceLabeled{{{to_mm<72>(262.73), to_mm<72>(322.03), Center, "Time B Auto-UnQ", ""}, 2, 0}, {"Off", "On"}},
		AltParamChoiceLabeled{{{to_mm<72>(71.16), to_mm<72>(242.1), Center, "Stereo Mode A", ""}, 2, 0}, {"Off", "On"}},
		AltParamChoiceLabeled{{{to_mm<72>(217.15), to_mm<72>(242.1), Center, "Stereo Mode B", ""}, 2, 0}, {"Off", "On"}},
