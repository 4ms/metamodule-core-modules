...
{
struct FadeOutInfo : ModuleInfoBase {
	static constexpr std::string_view slug{"FadeOut"};
	static constexpr std::string_view description{"Fade Out"};
	static constexpr uint32_t width_hp = 6;
	static constexpr std::string_view svg_filename{"res/modules/FadeOut_artwork.svg"};
	static constexpr std::string_view png_filename{"4ms/fp/FadeOut.png"};
