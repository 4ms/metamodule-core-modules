...
struct PEGInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 52> Elements{{
		...
		Davies1900hBlackKnob{{to_mm<72>(34.16), to_mm<72>(170.68), Center, "Scale Red", ""}, 1.0f, -100, 100, "%"},
		...
		Davies1900hBlackKnob{{to_mm<72>(192.91), to_mm<72>(151.47), Center, "Skew Blue", ""}, 0.5f, -100, 100, "%"},
		...
		AltParamChoiceLabeled{{{to_mm<72>(120.8), to_mm<72>(107.7), Center, "Async Red Mode", ""}, 2, 0}, {"ASR", "AR"}},
		AltParamChoiceLabeled{{{to_mm<72>(167.56), to_mm<72>(107.7), Center, "Async Blue Mode", ""}, 2, 0}, {"ASR", "AR"}},
		AltParamChoiceLabeled{{{to_mm<72>(68.06), to_mm<72>(45.56), Center, "Free-Running Ping Red", ""}, 2, 0}, {"On", "Off"}},
		AltParamChoiceLabeled{{{to_mm<72>(220.56), to_mm<72>(45.56), Center, "Free-Running Ping Blue", ""}, 2, 0}, {"On", "Off"}},
		AltParamChoiceLabeled{{{to_mm<72>(48.56), to_mm<72>(248.86), Center, "Skew Limit Red", ""}, 2, 0}, {"On", "Off"}},
		AltParamChoiceLabeled{{{to_mm<72>(239.76), to_mm<72>(248.86), Center, "Skew Limit Blue", ""}, 2, 0}, {"On", "Off"}},
		AltParamChoiceLabeled{{{to_mm<72>(111.11), to_mm<72>(281.13), Center, "EOF Red Mode", ""}, 4, 0}, {"EOF Gate", "EOF Trig", "Tap Tempo Gate", "Tap Tempo Trig"}},
		AltParamChoiceLabeled{{{to_mm<72>(177.5), to_mm<72>(281.13), Center, "EOF Blue Mode", ""}, 4, 0}, {"EOF Gate", "EOF Trig", "Tap Tempo Gate", "Tap Tempo Trig"}},
		AltParamChoiceLabeled{{{to_mm<72>(69.36), to_mm<72>(281.13), Center, "EOR Red Mode", ""}, 4, 0}, {"EOR Gate", "EOR Trig", "Half-Rise Gate", "Half-Rise Trig"}},
		AltParamChoiceLabeled{{{to_mm<72>(219.06), to_mm<72>(280.99), Center, "Half-R Blue Mode", ""}, 4, 0}, {"Half-Rise Gate", "Half-Rise Trig", "EOR Gate", "EOR Trig"}},
}};
