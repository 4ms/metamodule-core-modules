...
struct MPEGInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 25> Elements{{
		...
		AltParamChoiceLabeled{{{to_mm<72>(30.52), to_mm<72>(41.57), Center, "Sync Mode", ""}, 2, 0}, {"Sync", "Async"}},
		...
		AltParamChoiceLabeled{{{to_mm<72>(80.21), to_mm<72>(41.57), Center, "Free-running Ping", ""}, 2, 0}, {"On", "Off"}},
		AltParamChoiceLabeled{{{to_mm<72>(23.07), to_mm<72>(244.84), Center, "EOF Jack Type", ""}, 2, 0}, {"Gate", "Trigger"}},
		AltParamChoiceLabeled{{{to_mm<72>(23.07), to_mm<72>(244.84), Center, "EOF Jack Mode", ""}, 4, 1}, {"EOR", "EOF", "Half-Rise", "Tap Clock"}},
		AltParamChoiceLabeled{{{to_mm<72>(91.59), to_mm<72>(287.64), Center, "Cycle Jack Mode", ""}, 3, 0}, {"Trig", "Gate+Sync", "Gate"}},
		AltParamChoiceLabeled{{{to_mm<72>(23.01), to_mm<72>(287.64), Center, "Trig Jack Mode", ""}, 3, 0}, {"Async  Trig", "Async Gate", "Quantized Trig"}},
}};
